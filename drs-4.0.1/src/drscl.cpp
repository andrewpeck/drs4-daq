/********************************************************************\
  ...
  $Id: drscl.cpp 20430 2012-11-28 09:37:16Z ritt $
...
const char *drscl_svn_revision = "$Id: drscl.cpp 20430 2012-11-28 09:37:16Z ritt $";
   ...
   do {
      ...
      /* lock status ---------- */
         ...
         for (i=0 ; i<drs->GetNumberOfBoards() ; i++) {
            b = drs->GetBoard(i);
            b->SetRefclk(1);
            b->SetFrequency(b->GetFrequency(), true);
         }
      ...
      /* set trigger level ---------- */
         ...
         for (i=i_start ; i<i_end ; i++) {
            ...
            b->SetTriggerLevel(atof(str), false);
